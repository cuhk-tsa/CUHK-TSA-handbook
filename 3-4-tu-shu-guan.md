...
Learning Commons 和 Learning Garden 的的研討室需要提前租借，每次必須有_**至少三人**_使用，[預定網址](https://rbs.lib.cuhk.edu.hk/Booking/Login.aspx)選定時段後即可使用。UC的小組觀覽室也可於此系統登記。
...
[^1]: 一般書籍可以借閱一個月，大學生上限為50本書，研究生為30本。每本書最多可以續借3次。例外書籍例如 HKALL書籍，Reserved books 等則有另外限制。
